...
#define  USB_REQ_URL_VENDOR_CODE						0x02U
#define  USB_REQ_TYPE_URL                               0x02U
#define  USB_URL_SCHEME									0x00U
#define  USB_DESC_TYPE_URL                              0x03U
...
#endif
   uint8_t *(*GetUrlDesc)(uint16_t *length);
